 ...
 * Display the elements in vector 1 using the at() method
 * as well as ists size using the size() method
 *
 ...
 * Remember, that a 2D vector is a vector of vector<ind>
 *
...
int main() {
  ...
  cout << "Vector 2D:" << vector_2d.at(0).at(0) << " " << vector_2d.at(0).at(1)
