...
static auto GetSquareVAO(const unsigned int program) {
  ...
  {
    TracyGpuZone("Set vertex attributes");
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    {
      ZoneScopedN("Configure matrices");
      model_matrix =
    ...
    {
      ZoneScopedN("Swap buffers and poll events");
